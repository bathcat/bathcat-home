...
* So why dedicate a whole deck to it?

---

### But Why Still Care?
* **Classic trust fallacy** - Textbook example of trusting user input
* **Shame factor** - Classic blunder, like getting caught in a [land war in Asia](https://en.wikipedia.org/wiki/The_Princess_Bride)
* **Devastating potential** - Write access to persistence = game over
