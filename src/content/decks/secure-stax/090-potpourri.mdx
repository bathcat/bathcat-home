---
title: "Potpourri"
description: "Miscellaneous attacks and patterns with no obvious thematic home."
status: 'Live'
flavor: 'Deck'
---
...
1. What special characters enable **path traversal** attacks?
2. What's the difference between **DoS** and **DDoS**?
3. Why should you use **DTOs** instead of returning entities directly?
