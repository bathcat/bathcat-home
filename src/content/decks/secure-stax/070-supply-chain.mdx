...
1. What is the **core tension** in dependency management?
2. What do the 3 numbers in **Semantic Versioning** represent?
3. Name 2 tools or strategies for managing dependency updates.


---

### Roadmap
1. Dependencies & Attack Surface
2. Problem #1: Updates Break Things
3. Problem #2: You Need Security Patches NOW
4. The Tension Visualized
...
### Package Lock Files
* **[package-lock.json](https://docs.npmjs.com/cli/v8/configuring-npm/package-lock-json)** (npm) / **yarn.lock** / **pnpm-lock.yaml**
  - Exact version of every dependency (recursive)
  - Includes integrity checksums
  - Ensures repeatable builds
* **packages.lock.json** ([NuGet](https://devblogs.microsoft.com/dotnet/enable-repeatable-package-restores-using-a-lock-file/))
