---
title: "Auth"
description: "Authentication and authorization patterns for Angular and .NET applications. Learn RBAC, resource-based authorization, and when authorization logic belongs in your business layer."
status: 'Live'
flavor: 'Deck'
---
