...
1. List 3 different conditional constructs
1. Contrast 'value equality' with 'reference equality'
1. Explain why you might prefer `foreach` to `for`
...
| Op    | Short Circuit?                     | Name |
| :---- | :--------------------------------- | :--- | 
| `&&`  | <span style="color:green">✓</span> | [Conditional AND](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/boolean-logical-operators#logical-and-operator-) |
| `&`   | <span style="color:red">✗</span>   | [Logical AND](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/boolean-logical-operators#logical-and-operator-) |
| `\|\|`  | <span style="color:green">✓</span> | [Conditional OR](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/boolean-logical-operators#logical-or-operator-) |
| `\|`   | <span style="color:red">✗</span>   | [Logical OR](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/boolean-logical-operators#logical-or-operator-) |
| `^`   | <span style="color:red">✗</span>   | [Logical XOR](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/boolean-logical-operators#logical-exclusive-or-operator-) |
...
Console.WriteLine($"4: {true | false}");

Console.WriteLine($"5: {true ^ false}");
Console.WriteLine($"6: {true ^ true}");
