---
title: "Syntax Basics"
description: "Built-in types, variables, comments, and `null`"
status: 'Live'
flavor: 'Deck'
---
...
1. Define 'string interning'
2. Explain the `var` keyword
3. Contrast the modern nullable types with legacy behavior
...
- Have a language keyword + a .NET type
- e.g.
...
* [**System.Boolean**](https://learn.microsoft.com/en-us/dotnet/api/system.boolean)
  - Keyword: `bool`
* [**Integrals**](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/integral-numeric-types)
...
* [**Character**](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/char)
  - Keyword: `char`
  - UTF-16 encoded
...
* [System.Decimal](https://learn.microsoft.com/en-us/dotnet/api/system.decimal) - 128-bit decimal type
...
### Example: User Service (Old School)
```csharp {11}
