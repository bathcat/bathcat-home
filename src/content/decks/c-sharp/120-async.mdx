---
title: "Async"
description: "Improve C# application responsiveness by replacing blocking I/O with asynchronous operations using async/await and Task. Learn the core concepts and how to run multiple operations concurrently."
status: 'Live'
flavor: 'Deck'
---
